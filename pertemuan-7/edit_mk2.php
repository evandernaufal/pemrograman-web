...
<body>
    <?php   
        ...
        if (isset($_POST["kodemk"])) {
            ...
            #cara lain update
            #UPDATE matakuliah SET namamk='".namamk."', kategori='".kategori."', sks='".sks."' WHERE
    ...
    <div class="container">
        ...
        <div class="alert alert-success alert-dismissible fade show">
            ...
            Data berhasil diupdate ke dalam database. Halaman ini akan kembali ke List Mahasiswa dalam 3 detik.
        </div>
        <?php 
            }
            else if ($status == 0){
        ...
        <form id="myform" method="post" action="edit_mk2.php">
            <div class="form-group">
                ...
                <input id="kodemk" class="form-control" type="text" name="kodemk" value="<?php echo $kodemk ?>" readonly  <?php echo $disableForm ?>>
            </div>
            <div class="form-group">
                <label>Nama Mata Kuliah</label>
                <input id="namamk" class="form-control" type="text" name="namamk"  <?php echo $disableForm ?> value="<?php echo $namamk ?>" >
            </div>
            <div class="form-group">
